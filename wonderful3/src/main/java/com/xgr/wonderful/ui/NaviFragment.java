...
public class NaviFragment extends Fragment implements OnClickListener
    ...
    private static final int GONGFRAGAMENT = 6;
    
    private static final int ARFRAGMENT = 7;
    ...
    private TextView navi_gong;
    
    private TextView navi_ar;
    ...
    private void init() {
        ...
        navi_gong=(TextView) rootView.findViewById(R.id.tv_navi_main1);
        navi_ar=(TextView) rootView.findViewById(R.id.tv_navi_main2);
        ...
        navi_gong.setSelected(false);
        navi_ar.setSelected(false);
        ...
        navi_gong.setOnClickListener(this);
        
        navi_ar.setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        ...
        case R.id.tv_navi_main1:
               ...
               navi_gong.setSelected(true);
               navi_ar.setSelected(false);
               
               OnTabSelected(GONGFRAGAMENT);
          	break;
          	
           case R.id.tv_navi_main2:
             	 navi_home.setSelected(false);
                  navi_feedback.setSelected(false);
                  navi_settings.setSelected(false);
                  navi_intro.setSelected(false);
                  ...
                  navi_gong.setSelected(false);
                  navi_ar.setSelected(true);
                  
                  OnTabSelected(ARFRAGMENT);
             	break;
...
//			agent.startFeedbackActivity();
        ...
        case GONGFRAGAMENT: 
        	...
        	hideFragments(transaction);
        	if (null == mGongFragment) {
        		mGongFragment = new GongFragment();
                transaction.add(R.id.center, mGongFragment);
            } else {
                transaction.show(mGongFragment);
            }
            break;
        ...
        case ARFRAGMENT: 
        	...
        	if (null == mArFragment) {
                ...
                transaction.add(R.id.center, mArFragment);
            } else {
                transaction.show(mArFragment);
            }
            break;
        }
        transaction.commit();
    ...
    private void hideFragments(FragmentTransaction transaction) {
    	...
    	if(mGongFragment!=null){
    		transaction.hide(mGongFragment);
    	}
    	if(mArFragment!=null){
    		transaction.hide(mArFragment);
    	}
    }
